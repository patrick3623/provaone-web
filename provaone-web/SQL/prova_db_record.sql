...
CREATE TABLE `record` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_record_1_idx` (`id_user`),
  CONSTRAINT `fk_record_1` FOREIGN KEY (`id_user`) REFERENCES `user` (`id`)
...
INSERT INTO `record` VALUES (1,'394384893743434','Teste',1),(2,'00:22','Teste',1),(3,'13:01','Atrasado',56),(4,'13:01','Atrasado',56);
